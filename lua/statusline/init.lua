...
local utils = require("statusline.components.utils")
local spotify = require("statusline.components.spotify")
local diagnostics = require("statusline.components.diagnostics")

local components = require("statusline.utils")
...
function StatusLine()
  ...
  return table.concat({
    ...
    components.get_component("StatusBranch", " ♥ ", 1),
    components.get_component("StatusMode", " ", 1),
    components.get_component("StatusMode", "%l:%c"),
  })
end
