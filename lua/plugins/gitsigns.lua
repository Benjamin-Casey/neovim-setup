return {
	...
	keys = {
		...
		{ "<leader>gb", "<cmd>Gitsigns blame<CR>", desc = "Gitsigns buffer blame" },
		{
			"<leader>gB",
			"<cmd>Gitsigns toggle_current_line_blame<CR>",
			desc = "Gitsigns buffer blame toggle",
		},
		{ "<leader>gd", "<cmd>Gitsigns preview_hunk_inline<CR>", desc = "Gitsigns preview hunk inline" },
